...
public class Finance {
    ...
    static {
        System.out.println(Objects.requireNonNull(Finance.class.getClassLoader().getResource("libWeWorkFinanceSdk_Java.so")).getPath());
        System.load(Objects.requireNonNull(Finance.class.getClassLoader().getResource("libWeWorkFinanceSdk_Java.so")).getPath());
    }
}
